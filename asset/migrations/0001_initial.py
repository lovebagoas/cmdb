    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.CharField(blank=True, max_length=8192, null=True, verbose_name='\u4e3b\u673aIP')),
                ...
                ('asset_type', models.CharField(blank=True, max_length=32, null=True, verbose_name='\u4e3b\u673a\u7c7b\u578b')),
                ...
                ('wan_ip', models.CharField(blank=True, max_length=8192, null=True, verbose_name='\u5916\u7f51IP')),
            ],
        ),
        migrations.CreateModel(
            name='AssetGroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=32, null=True, verbose_name='alias name show to users')),
            ],
        ),
        migrations.CreateModel(
            name='crontab_svn',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_rev', models.IntegerField(verbose_name='goproject latest successful revision')),
                ('gotemplate_last_rev', models.IntegerField(verbose_name='gotemplate latest successful revision')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, verbose_name='goservices services name')),
                ('env', models.IntegerField(blank=True, choices=[(1, '\u751f\u4ea7\u73af\u5883'), (2, '\u6d4b\u8bd5\u73af\u5883')], null=True, verbose_name='\u8fd0\u884c\u73af\u5883')),
                ...
                ('level', models.CharField(max_length=128, null=True, verbose_name='level')),
        ...
        migrations.AddField(
            model_name='crontab_svn',
            name='hostname',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.minion'),
        ),
        migrations.AddField(
            model_name='crontab_svn',
            name='minion_hostname',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset.cron_minion'),
        ),
        migrations.AddField(
            model_name='cron_minion',
            name='saltminion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset.minion'),
        ),
        migrations.AddField(
